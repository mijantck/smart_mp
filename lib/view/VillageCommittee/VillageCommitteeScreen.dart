...
class VillageCommitteeScreen extends StatefulWidget {
  const VillageCommitteeScreen({super.key});

  @override
  State<VillageCommitteeScreen> createState() => _VillageCommitteeScreenState();
}

class _VillageCommitteeScreenState extends State<VillageCommitteeScreen> {
  ...
  String userType = 'village_community';
  Union? selectedUnion;
